#> minihilly_dungeoneer_grid:destroy/destroy_all
...
execute as @e[tag=minihilly_dungeoneer_grid.grid_manager] run scoreboard players reset @s
...
execute as @e[tag=minihilly_dungeoneer_grid.cell] run scoreboard players reset @s

kill @e[tag=minihilly_dungeoneer_grid.grid_manager]
kill @e[tag=minihilly_dungeoneer_grid.cell]
kill @e[tag=minihilly_dungeoneer_grid.debug.armor_stand]
kill @e[tag=minihilly_dungeoneer_grid.chunk]
