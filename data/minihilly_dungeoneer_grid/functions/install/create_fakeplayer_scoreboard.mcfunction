#>  minihilly_dungeoneer_grid:install/create_fakeplayer_scoreboard
#       initializes fakeplayer values for grid generator

scoreboard players add $installed minihilly_dungeoneer_grid.setup 1
...
scoreboard players set #uuids_available minihilly_dungeoneer_grid.config 4
...
scoreboard players set #16 minihilly_dungeoneer_grid.const 16

#>
#   constant value of 8. For chunk calculations
#@internal
#define score_holder #8
scoreboard players set #8 minihilly_dungeoneer_grid.const 8

#>
#   constant value of -1. For chunk calculations
#@internal
#define score_holder #-1
scoreboard players set #-1 minihilly_dungeoneer_grid.const -1