#>  minihilly_2d_grid:install/create_fakeplayer_scoreboard
#       initializes fakeplayer values for grid generator

scoreboard players set #doesExist minihilly_grid.config 1
...
scoreboard players set #uuids_available minihilly_grid.config 4
...
scoreboard players set #16 minihilly_grid.const 16

#>
#   constant value of 8. For chunk calculations
#@internal
#define score_holder #8
scoreboard players set #8 minihilly_grid.const 8

#>
#   constant value of -1. For chunk calculations
#@internal
#define score_holder #-1
scoreboard players set #-1 minihilly_grid.const -1