#> minihilly_gen_grid:gen/loop/grid_manager/destroy_cell_marker
...
# for debugging only
#execute at @s run summon armor_stand ~ ~ ~ {Tags:["minihilly_gen_grid.debug.armor_stand"],Small:1b,CustomName:'{"text":"killchunk"}',CustomNameVisible:1b,NoGravity:1b}
