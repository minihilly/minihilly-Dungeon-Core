#> minihilly_gen_grid:destroy/destroy_all
...
execute as @e[tag=minihilly_gen_grid.grid_manager] run scoreboard players reset @s
...
execute as @e[tag=minihilly_gen_grid.cell] run scoreboard players reset @s

kill @e[tag=minihilly_gen_grid.grid_manager]
kill @e[tag=minihilly_gen_grid.cell]
kill @e[tag=minihilly_gen_grid.debug.armor_stand]
kill @e[tag=minihilly_gen_grid.chunk]
